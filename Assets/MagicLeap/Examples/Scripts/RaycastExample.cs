...
namespace MagicLeap
{
    ...
    public class RaycastExample : MonoBehaviour
    {
        ...
        private RaycastMode _raycastMode = RaycastMode.Eyes;
        ...
        private void UpdateRaycastMode()
        {
            ...
            switch (_raycastMode)
            {
                ...
                case RaycastMode.Head:
                {
                    ...
                    networkManager.GetComponent<SocketClient>().useHeadPose = true;
                    break;
                }
                case RaycastMode.Eyes:
                {
                    _raycastEyes.gameObject.SetActive(true);
                    networkManager.GetComponent<SocketClient>().useHeadPose = false;
                    break;
                }
            }
        }
